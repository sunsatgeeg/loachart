...
document.querySelector("#matchstart").addEventListener('click', async function () {
    ...
    await loadJavascript('/js/cardcalc/cardocr.js?v=01182203');
});
...
document.querySelector('#finishyes').addEventListener('click', async function () {
    ...
    await loadJavascript('/js/cardcalc/cardcalcul.js?v=01182203');
...
if (getCookie('savecarddeck') != '') {
    (async () => {
        ...
        await loadJavascript('/js/cardcalc/cardeffect.js?v=01182203');
